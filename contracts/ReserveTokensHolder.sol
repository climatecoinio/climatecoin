...
contract ReserveTokensHolder is Owned {
    ...
    ClimateContribution contribution;
    MiniMeToken climate;

    function ReserveTokensHolder(address _owner, address _contribution, address _climate) {
        owner = _owner;
    ...
    function collectTokens() public onlyOwner {
        ...
        assert(climate.transfer(owner, balance));
